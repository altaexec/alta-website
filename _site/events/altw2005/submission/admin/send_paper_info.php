<?php 
	...
	$url = "<a href=\"#\" onClick=\"".make_Popup_Window("mailing_list_by_papers.php",$parameterList,700,900,"yes")."\">edit email list</a>&nbsp;|&nbsp; <a href=\"#\" onClick=\"".make_Popup_Window( "view_emails_list_by_papers.php",$parameterList,600,900,"yes")."\">view email list</a>";	
