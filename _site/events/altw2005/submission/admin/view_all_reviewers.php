  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="1">
    ...
    <tr> 
      <td colspan="2"><table width="100%" border="1" cellspacing="2" cellpadding="1">
          <tr> 
            <td width="15%"><a href="view_all_reviewers.php?sort=1"><img src="<?php echo $php_root_path ; ?>/images/up.gif" border=0></a>&nbsp;Reviewer 
              &nbsp;<a href="view_all_reviewers.php?sort=2"><img src="<?php echo $php_root_path ; ?>/images/down.gif" border=0></a></td>
            <td width="25%"><a href="view_all_reviewers.php?sort=3"><img src="<?php echo $php_root_path ; ?>/images/up.gif" border=0></a>&nbsp;Full Name&nbsp;<a href="view_all_reviewers.php?sort=4"><img src="<?php echo $php_root_path ; ?>/images/down.gif" border=0></a></td>
            <td width="50%"><a href="view_all_reviewers.php?sort=5"><img src="<?php echo $php_root_path ; ?>/images/down.gif" border=0></a>&nbsp;Organization&nbsp;<a href="view_all_reviewers.php?sort=6"><img src="<?php echo $php_root_path ; ?>/images/down.gif" border=0></a></td>
            <td width="10%">&nbsp;</td>
          </tr>
          ...
          <tr> 
            ...
            <td><a href="confirm_delete_reviewer.php?registerID=<?php echo $memberInfo -> RegisterID; ?>">Delete</a></td>
          </tr>
