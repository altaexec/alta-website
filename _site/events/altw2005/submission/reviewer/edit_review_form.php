...
//	extract ( $_SESSION , EXTR_REFS ) ;
	...
	{		
		...
		{
			header("Location: edit_review_form.php?paperid=" . $HTTP_POST_VARS["paperid"] ) ;
			exit ;
		}	
		$error_array = array() ;		
...
//	display ( $error_array ) ;
	...
	else 
	{
		...
		{	
			...
			if ( ( $reviewInfo = get_review($HTTP_POST_VARS["paperid"] , &$err_message ) ) === false )
			{
				do_html_header("Edit Review Form Failed" , &$err_message );	
				$err_message .= " Could not execute \"get_review\" in \"edit_review_form.php\". <br>\n" ;
				$err = $err_message . "<br><br> Try <a href='edit_review_form.php?paperid=".$HTTP_GET_VARS["paperid"]."'>again</a>?" ;
				do_html_footer(&$err);
				exit;			
			}
		
			//Assign the values to the variables
			$HTTP_POST_VARS["objectives"] = $reviewInfo -> Objectives ;
			$HTTP_POST_VARS["validity"] = $reviewInfo -> Validity;
			$HTTP_POST_VARS["innovativeness"] = $reviewInfo -> Innovativeness;
			$HTTP_POST_VARS["presentation"] = $reviewInfo -> Presentation;
			$HTTP_POST_VARS["bibliography"] = $reviewInfo -> Bibliography ;
			$HTTP_POST_VARS["acceptpaper"] = $reviewInfo -> AcceptPaper ;
			$HTTP_POST_VARS["acceptposter"] = $reviewInfo -> AcceptPoster ;
			$HTTP_POST_VARS["comments"] = stripslashes ( $reviewInfo -> Comments ) ;			
		}
		do_html_header("Edit Review Form" , &$err_message );
	}
...
<form enctype="multipart/form-data" action="edit_review_form.php" method="post" name="frmReview">
  <table width="100%" border="0" cellspacing="0" cellpadding="1">
    ...
    <tr> 
      <td align="center"><h4>Authors:</strong><?php if ( $authors = retrieve_authors( $paperInfo -> PaperID , &$err_message ) )
	{
		echo $authors ;
	}
	else
	{
		echo " <font color=\"#FF0000\"> Could not read author table. Try <a href='edit_review_form.php?paperid=".$HTTP_GET_VARS["paperid"]."'>again</a>?</font>" ;
	}
	   ?></h4></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td><table width="90%" border="1" cellpadding="0" cellspacing="2">
          ...
          <tr> 
            ...
            <td align="center"><input name="objectives" type="radio" value="1" <?php if ($HTTP_POST_VARS["objectives"] == 1) echo "checked";?> ></td>
...
and there are no technical and/or methodological flaws</td>
            <td align="center"><input name="validity" type="radio" value="1" <?php if ($HTTP_POST_VARS["validity"] == 1) echo "checked";?>></td>
...
contribution to the field</td>
            <td align="center"><input name="innovativeness" type="radio" value="1" <?php if ($HTTP_POST_VARS["innovativeness"] == 1) echo "checked";?>></td>
...
paper are clearly described</td>
            <td align="center"><input name="presentation" type="radio" value="1" <?php if ($HTTP_POST_VARS["presentation"] == 1) echo "checked";?>></td>
          ...
          <tr> 
            ...
            <td align="center"><input name="bibliography" type="radio" value="1" <?php if ($HTTP_POST_VARS["bibliography"] == 1) echo "checked";?>></td>
          ...
          <tr> 
            ...
            <td align="center"><input name="acceptpaper" type="radio" value="1" <?php if ($HTTP_POST_VARS["acceptpaper"] == 1) echo "checked";?>></td>
          ...
          <tr> 
            ...
            <td align="center"><input name="acceptposter" type="radio" value="1" <?php if ($HTTP_POST_VARS["acceptposter"] == 1) echo "checked";?>></td>
