...
//	require_once("includes/user_authen_fns.php");
	$php_root_path = ".." ;
...
//	$fileid =& $HTTP_GET_VARS["fileid"] ;
	...
	$sql .= " WHERE F.FileID=" . $HTTP_GET_VARS["fileid"] . " AND F.PaperID=P.PaperID AND P.MemberName='" . $_SESSION["valid_user"] . "' AND Withdraw='false'" ;
...
//	echo "\$sql: " . $sql . "<br>\n";
	...
	if ( !$result )
	{
		...
		$err_message .= "<br><br> Try <a href='download_file.php?fileid=" . $HTTP_GET_VARS["fileid"] . "'>again</a>?" ;		
