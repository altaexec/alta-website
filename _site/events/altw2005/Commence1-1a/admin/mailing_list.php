<?php 
	...
	//Reset the array
	reset($arrEmailInfo);
	if($HTTP_GET_VARS["sort"] == 7) { //Arrary is to be sort by "status" ascending
		asort($arrEmailInfo);
		$sortStr = "Email Status - Ascending";
	}else if($HTTP_GET_VARS["sort"] == 8) { //Arrary is to be sort by "status" descending
		arsort($arrEmailInfo);
...
<form name="frmMailList" method="post" action="update_mailing_list.php">
  <table width="90%" border="0" cellspacing="0" cellpadding="2">
    <tr> 
      ...
      <td align="right"><a href="view_emails_list.php?letterID=<?php echo $letterID; ?>&recipientGroupName=<?php echo $letterInfo -> RecipientGroupName; ?>">view 
        email list</a></td>
    </tr>
    <tr> 
      <td colspan="4">&nbsp;</td>
    ...
    <tr> 
      ...
      <td width="20%"><?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=1&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"ASC"); ?>&nbsp; 
        <strong>User Name</strong>&nbsp;<?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=2&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"DESC"); ?>
      </td>
      <td width="25%"><?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=3&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"ASC"); ?>&nbsp;	
        <strong>Email Address</strong>&nbsp;<?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=4&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"DESC"); ?>	
      </td>
      <td width="20%" align="center"><?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=7&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"ASC"); ?>&nbsp;<strong>Email Status</strong>&nbsp;<?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=8&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"DESC"); ?></td>
      <td width="30%"><?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=5&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"ASC"); ?>&nbsp;	
        <strong>Full Name</strong>&nbsp<?php $urlStr = "javascript:papercheckbox( 'mailing_list.php' , '?sort=6&showing=".$HTTP_GET_VARS["showing"] . "')" ; echo format_Sorting_URL($urlStr,"DESC"); ?>
      </td>
    </tr>
    <?php 
