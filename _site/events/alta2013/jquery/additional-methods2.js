...
jQuery.validator.addMethod("instname", function(value, element) {
	return this.optional(element) || /^[0-9a-z-.,()'\"\s]+$/i.test(value);
}, "Enter the name of your Institution please");

jQuery.validator.addMethod("addy", function(value, element) {
	return this.optional(element) || /^[0-9a-z-.,()'\"\s\/]+$/i.test(value);
...
}, "Enter a postcode please");

jQuery.validator.addMethod("provcount", function(value, element) {
	return this.optional(element) || /^[a-z-.\s]+$/i.test(value);
}, "Use only letters and spaces, and optionally '.' and/or '-' please");
